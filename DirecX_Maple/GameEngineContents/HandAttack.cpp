...
void HandAttack::Start()
{
	...
	//StringAttack->AutoSpriteSizeOn();
	StringAttack->SetImageScale({ 26.0f, 760.0f });
	//StringAttack->Transform.SetLocalPosition({ 130.0f, -300.0f, 1.0f });
	...
	StringCol->Transform.SetLocalScale({ 26.0f, 760.0f });
	//StringCol->Transform.SetLocalPosition({ 130.0f, -300.0f, 1.0f });
